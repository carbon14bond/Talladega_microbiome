...
spacer<- ggdraw()
vnsp1<-plot_grid(spacer,venndiagram16S,spacer,rel_widths = c(0.2,1,0.1), ncol=3)
vnsp2<-plot_grid(spacer,venndiagramITS,spacer,rel_widths = c(0.2,1,0.1), ncol=3)
L1<- plot_grid(ASVaccumsub16S,vnsp1,
          labels=c('A','B'), ncol=2, rel_widths = c(1.5,1))
L2<- plot_grid(ASVaccumsubITS,vnsp2,
          labels=c('F','G'), ncol=2, rel_widths = c(1.5,1))
...
LM1<- plot_grid(L1, M1, ncol=1)
LM2<- plot_grid(L2, M2, ncol=1)

row1<- plot_grid(LM1, R1, ncol=2, rel_widths = c(1.1,1))
row2<- plot_grid(LM2, R2, ncol=2, rel_widths = c(1.1,1))
...
plotout <- "Overview_05.14.2025.tiff"

...
## Analysis_0.1: Overview of 16S and ITS ASVs Data
...
### remove samples with less than 1000 reads? We'll wait for rarefying to trim, let's first just remove zeros. 
...
## 0.1.2 
## Rarefying for downstream analyses
#### 16S rarefying
16S data rarefying
```{r}
library(GUniFrac)
...
set.seed(2025)
rarefiedITS <- Rarefy(cured_asvsITS, 1028)
